...
object Crypto {
  ...
  private lazy val nativeSecp256k1: Option[Secp256k1] = Some(
    Secp256k1JvmKt.getSecpk256k1
  )
  ...
  /** Computes ecdh using secp256k1's variant: sha256(priv * pub serialized in
    * compressed format)
    *
    * @param priv
    *   private value
